...
<div class="container-fluid" style="max-width:1100px;margin:0 auto;padding:10px;background-color:white;">
    ...
    @endif
    {!! Form::model($user, ['method' => 'PATCH','route' => ['perfiles.update', $user->id],'files'=>'true' ]) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            ...
            <a class="btn btn-primary" href="{{ route('perfiles.index') }}"> Cancelar</a>
        </div>
    </div>
    {!! Form::close() !!}
